...
app.get(
  "/api/enrollment/auditor-dashboard/active/work-category",
  (req, res, next) => {
    const payload = [
      {
        id: 1,
...
app.get("/api/enrollment/rebuttal/configuration/workflow", (req, res, next) => {
  res.status(200).json([
    {
      flowId: 2,
      roleId: 3,
...
app.post("/api/enrollment/rebuttal/configuration/save", (req, res, next) => {
  res.status(200).json([
    {
      flowId: 2,
      roleId: 3,
...
app.get(
  "/api/enrollment/manager/landing/rebuttal-review/count",
  (req, res, next) => {
    res.status(200).json([
      {
        requestType: "Workbasket",
...
app.post(
  "/api/enrollment/resource-dashboard/audit-transaction",
  (req, res, next) => {
    res.status(200).json({
      auditSummaryDtos: [
        {
...
app.get("/api/enrollment/landing/request-types", (req, res, next) => {
  const types = {
    enrollmentRequestTypes: [
      {
        id: 1,
        name: "Workbasket"
      },
...
app.get("/api/enrollment/landing/transaction-category", (req, res, next) => {
  const types = [
    {
...
app.get("/api/enrollment/landing/pend/details", (req, res, next) => {
  const types = [
    {
      pendReasonCode: 91,
...
app.get("/api/enrollment/landing/route/details", (req, res, next) => {
  const types = [
    {
      routeReasonCode: 39,
...
app.post("/api/enrollment/landing/complete", (req, res, next) => {
  res.status(200).json("success");
});

app.post("/api/enrollment/landing/pend", (req, res, next) => {
  res.status(200).json("success");
});

app.get("/api/enrollment/landing/route/:id", (req, res, next) => {
  const leadNames = [
    {
      routeUserId: 152,
...
app.post("/api/enrollment/landing/route", (req, res, next) => {
  res.status(200).json("success");
});
...
app.get("/api/enrollment/template/list", (req, res, next) => {
  const payload = [
    {
      existingTemplate: {
        "FSubscriber Id": "Subscription Id",
        "FReceipt Date": "Receipt Date",
        "FMember Id": "Error Description"
      },
      fileHeaders: [
        "Subscription ID",
        "Subscriber Name",
      ...
      fileId: 0,
      fileName: "create2.xlsx",
      id: 12,
      mandatoryHeaders: null,
      slNo: 0,
      systemHeaders: [
        "Subscription ID",
        "Subscriber Name",
...
app.post("/api/enrollment/landing/route/to-user-name", (req, res, next) => {
  const response = [
    {
      routeUserId: 152,
      routeUserName: "Dhanya S"
...
app.post(
  "/api/enrollment/specialist/enrollment/audit-transaction-trend/grid-view",
  (req, res, next) => {
    const payload = [
      {
        slNo: 1,
        subscriptionId: "0000000021_001",
        workCategory: "FALL_OUT",
...
app.post(
  "/api/enrollment/specialist/enrollment/audit-transaction-trend/report",
  (req, res, next) => {
    res.status(200).json();
  }
);
...
app.post("/api/enrollment/landing/:id", (req, res, next) => {
  const member = {
    taskAssignmentId: 406,
    subscriptionId: "qwqqewewee",
    requestType: "Workbasket",
...
app.get(
  "/api/enrollment/landing/transaction-detail?taskId=:id",
  (req, res, next) => {
...
app.post("/api/enrollment/sampling/auditor/queue/add", (req, res, next) => {
  res.status(200).json(200);
});

app.post("/api/enrollment/auditor/queue/self-add", (req, res, next) => {
  const payload = { success: "OK" };
  res.status(200).json(payload);
});

app.get("/api/enrollment/audit/configuration/checklist", (req, res, next) => {
  const payload = {
    checkpoints: {
      Workbasket: ["Workbasket1", "Workbasket2", "Workbasket3", "Workbasket4"],
      Reconciliation: [
        "Reconciliation1",
        "Reconciliation2",
        "Reconciliation3",
      ...
      Fallout: ["Fallout1", "Fallout2", "Fallout3", "Fallout4"],
      "Bulk Termination": [
        "Bulk Termination1",
        "Bulk Termination2",
        "Bulk Termination3",
    ...
    "workCategoryEnabledOrDisabled": {
      "Workbasket": false,
      "Bulk Termination": true,
      "Fallout": false,
      "Reconciliation": true
    }
  };
...
app.post(
  ...
  (req, res, next) => {
    const payload = {
      checkpoints: {
        Workbasket: ["Workbasket1", "Workbasket2", "Workbasket3"],
        Reconciliation: [
          "Reconciliation1",
          "Reconciliation2",
          "Reconciliation3"
        ],
        Fallout: ["Fallout1", "Fallout2", "Fallout3"]
      },
      enabled: true
    };
    res.status(200).json(payload);
...
app.get(
  ...
  (req, res, next) => {
    res.status(200).json(
      [
        {
          "workCategory": "Group Renewal",
          "enabled": true
        },
        {
          "workCategory": "New Group Enrollment",
          "enabled": false
        },
        {
          "workCategory": "Reconciliation",
...
app.post(
  "/api/enrollment/auditor-dashboard/processed-vs-audited/details",
  (req, res, next) => {
    const payload = [
      {
        slNo: 1,
...
app.post(
  ...
  (req, res, next) => {
    res.status(200).json([
      { workCategory: "Workbasket", requestCount: 14 },
      { workCategory: "Fallout", requestCount: 13 },
      { workCategory: "Reconciliation", requestCount: 12 },
      { workCategory: "IDCardRequest", requestCount: 15 }
    ]);
  }
);
...
app.post(
  ...
  (req, res, next) => {
    res.status(200).json([
      ...
      { workCategory: "Reconciliation", requestCount: 12 },
      { workCategory: "IDCardRequest", requestCount: 15 },
      { workCategory: "Gender Correction", requestCount: 11 },
      { workCategory: "Address Chang", requestCount: 12 }
    ]);
  }
);
app.post(
...
app.post(
  ...
  (req, res, next) => {
    res.status(200).json([
      ...
      { status: "Transaction Count Mismatch", transactionCount: 1 }
    ]);
  }
);
app.post(
    ...
    res.status(200).json([
      {
        ...
        successAuditCount: 4,
        failedAuditCount: 2,
        transactionCountMismatch: 5
      },
      {
        startDate: "2021-01-16",
        successAuditCount: 6,
        failedAuditCount: 2,
        transactionCountMismatch: 1
      },
      {
...
app.post(
  ...
  (req, res, next) => {
    res.status(200).json([
      ...
      {
        benefitPlanId: "999",
        benefitPlanName: "PHC_BenefitPlan",
        transactionCount: 2
      },
      {
        benefitPlanId: "H5216-076-000",
...
app.get("/api/enrollment/auditor-dashboard/user-group", (req, res, next) => {
  res.status(201).json([
    {
      groupId: 13,
      groupName: "Itemized_Team"
...
app.post(
  "/api/enrollment/auditor-dashboard/user-group/specialists",
  (req, res, next) => {
    res.status(201).json([
      {
        specialistId: 7,
...
app.post(
  "/api/enrollment/auditor-dashboard/rebuttal-status/details",
  (req, res, next) => {
    const payload = [
      {
        slNo: 1,
...
app.post(
  "/api/enrollment/auditor-dashboard/audit-sampling-by-audit/report",
  (req, res, next) => {
    res.status(200).json();
  }
);
app.post(
  "/api/enrollment/auditor-dashboard/audit-sampling-by-audit/details",
  (req, res, next) => {
    payload = [
      {
        slNo: 0,
...
app.post(
  "/api/enrollment/auditor-dashboard/audit-status-specialist/details",
  (req, res, next) => {
    payload = [
      {
        slNo: 0,
...
app.post(
  "/api/enrollment/auditor-dashboard/rebuttal-status",
  (req, res, next) => {
    res.status(200).json({
...
app.post(
  "/api/enrollment/auditor-dashboard/audit-status-specialist/report",
  (req, res, next) => {
    res.status(200).json("success");
  }
);
...
app.post(
  "/api/enrollment/auditor-dashboard/rebuttal-status/report",
  (req, res, next) => {
    res.status(200).json("success");
  }
);
app.post(
  "/api/enrollment/auditor-dashboard/processed-vs-audited/report",
  (req, res, next) => {
    res.status(200).json("success");
  }
);
...
app.get(
  "/api/enrollment/audit/specialist/queue/getFromDetail-transaction",
  (req, res, next) => {
    res.status(200).json({
      auditTaskId: 33,
      auditFlowId: 71,
      ...
      transactionType: "Create",
      transactionCount: 1,
      receiptDate: "2021-03-07",
      recordAge: 3,
      subscriberName: "Kritika Khan",
      memberId: "1000099913",
      memberLastName: "Khan",
      memberFirstName: "Kritika",
      memberDob: "01/18/2020",
      benefitPlanName: null,
      benefitPlanStartDate: null,
      benefitPlanEndDate: null,
      memberGroupName: "POINT Group",
      auditorName: "Nairobi",
      auditDate: "03/10/2021 02:33",
      userGroupName: "Reconciliation_group_B",
      errorDetails: "Error 8",
      isTransactionCountMismatch: false,
        ...
        attachments: [
          {
            filePosition: "attachmentOne",
            fileId: 331,
            fileName: "Auditor-1.xlsx"
          }
        ]
      },
      specialistComment: null,
      auditorComments: "Failed",
      specialistAttachmentDto: null,
      currentLevel: null
    });
  }
);
...
app.get(
  "/api/enrollment/audit/specialist/queue/audit-failed/details",
  (req, res, next) => {
    res.status(200).json([
      {
        auditTaskId: 13,
        enrollmentTaskId: 445,
        auditStagingId: null,
        auditFlowId: null,
        subscriptionId: "223286897",
        transactionType: "CREATE",
        recordAge: 0,
        subscriberName: null,
        memberGroupName: null,
        ...
        memberLastName: "",
        memberFirstName: "",
        memberDob: "01/18/2023",
        userGroupName: "Recon_group",
        priority: null,
        currentLevel: null,
        benefitPlanName: null,
        benefitPlanStartDate: null,
        auditAttachmentIdOne: null,
        auditAttachmentIdTwo: null,
        auditAttachmentIdThree: null,
        auditDate: "03/08/2021 09:31",
        auditorName: "Amilu Saji",
        errorDetails: "Plan effective date is not matching",
        auditorComments: null,
        isTransactionCountMismatch: null,
        benefitPlanEndDate: null,
        receiptDate: null,
        transactionCount: 5,
        reviewOrRebut: null,
        relationToSubscriber: null,
        specialistName: null,
        specialistComments: null,
        savedForLaterStatus: null,
        auditAttachmentOne: null,
        ...
        processedDate: null,
        queueName: null,
        auditAttachmentIdFour: null,
        auditAttachmentIdFive: null,
        auditAttachmentIdSix: null,
        finishTime: null,
        auditFlowComment: null,
        auditFlowAttachmentIdOne: null,
        auditFlowAttachmentIdTwo: null,
        auditFlowAttachmentIdThree: null,
        auditFlowAttachmentIdFour: null,
        auditFlowAttachmentIdFive: null
      }
    ]);
  }
);
...
app.get(
  "/api/enrollment/manager/landing/rebuttal-review/details",
  (req, res, next) => {
    res.status(200).json([
      {
        slNo: 1,
        auditFlowId: 2,
        subscriptionId: "87323245234",
        rebutOrAccept: "Rebutted",
        rebuttalLevel: "Level 1",
        promtStatus: "FAILED",
        specialistName: "Minna Minni",
        transactionType: "CREATE",
        transactionCount: 0,
        recordAge: 19,
        auditDate: "2021-03-03",
        auditorName: "Joey Tribbiani",
...
app.get(
  "/api/enrollment/manager/review-rebut/get-transactions",
  (req, res, next) => {
    res.status(200).json({
      auditFlowId: 8,
      auditTaskId: 7,
...
app.get(
  "/api/enrollment/manual-assignment/auditor-details",
  (req, res, next) => {
    res.status(200).json([
      {
        id: 203,
        ...
        assignCount: 7,
        userGroupIds: [46, 47],
        userGroupNames: ["fallout_group", "Recon_group"],
      },
    ]);
  }
);
app.post(
  "/api/enrollment/manual-assignment/unassigned-transaction",
  (req, res, next) => {
    res.status(200).json([
      {
        enrollmentTaskId: 436,
        enrollmentStagingId: 184,
        workCategory: "Fallout",
        subscriptionId: "223268197",
        priorityLevel: "High",
        completionDate: "02/23/2021",
        receiptDate: "02/17/2021",
        recordAge: 29,
        userGroupId: 47,
        specialistName: null,
        memberName: "Aleena Micheal",
        benefitPlanName: null,
        memberGroupId: "U 23997",
        memberGroupName: "Health Group",
        memberId: "367823-01",
        userGroupName: "fallout_group",
      },
      {
        enrollmentTaskId: 437,
        enrollmentStagingId: 185,
        workCategory: "Fallout",
        subscriptionId: "567234516",
        priorityLevel: "Medium",
        completionDate: "03/03/2021",
        receiptDate: "02/17/2021",
        recordAge: 29,
        specialistName: null,
        memberName: "Niya Jose",
        benefitPlanName: null,
        memberGroupId: "",
        memberGroupName: "",
        memberId: "578886-03",
