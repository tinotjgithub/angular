  ...
  parse(value: string): NgbDateStruct {
    if (value) {
      ...
      if (isNumber(dateParts[0]) && isNumber(dateParts[1]) && isNumber(dateParts[2])) {
        dia = this.ddIndex === 0 ? toInteger(dateParts[0]) :
        this.ddIndex === 1 ? toInteger(dateParts[1]) :
        this.ddIndex === 2 ? toInteger(dateParts[2]) : 0;
        mes = this.mmIndex === 0 ? toInteger(dateParts[0]) :
        this.mmIndex === 1 ? toInteger(dateParts[1]) :
