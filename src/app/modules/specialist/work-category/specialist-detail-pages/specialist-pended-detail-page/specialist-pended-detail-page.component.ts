...
@Component({
  selector: "app-specialist-pended-detail-page",
  templateUrl: "./specialist-pended-detail-page.component.html",
  styleUrls: ["./specialist-pended-detail-page.component.css"],
  providers: [ConfirmationService]
})
export class SpecialistPendedDetailPageComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.getWorkCategoryPendedData();
  }
  setWorkCategoryColumns() {
    this.cols = [
      { field: "id", header: "Task ID", visible: false },
      { field: "subscriptionId", header: "Subscription ID", visible: true },
      { field: "firstPendDate", header: "First Pend Date", visible: true },
      { field: "lastPendDate", header: "Last Pend Date", visible: true },
      {
        field: "pendReason",
        header: "Pend Reason",
        visible: true
  ...
  getWorkCategoryPendedData() {
    this.enrollmentManagementService.getWorkCategoryPendedDetailsData(
      this.type,
      "PENDED"
    );
    this.gridData = this.enrollmentManagementService.workCategoryPendedDetailsDataResponse;
    this.gridData = [];
    this.data = [];
