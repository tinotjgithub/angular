...
import { ClaimsOpenInventorySlaComponent } from '../../manager-dash-board/claims-open-inventory-sla/claims-open-inventory-sla.component';
import { DialogModule } from 'primeng/dialog';
import { FormsModule, ReactiveFormsModule } from '@angular/forms';
import { DropdownModule } from 'primeng/dropdown';
import { ClaimsOpenInventoryViewComponent } from '../../manager-dash-board/claims-open-inventory-view/claims-open-inventory-view.component';
...
describe('LandingPageComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [LandingPageComponent, ClaimsOpenInventorySlaComponent, ClaimsOpenInventoryViewComponent],
      imports: [
        RouterTestingModule,
        CommonModule,
        GoogleChartsModule,
