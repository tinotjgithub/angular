...
describe("AuditReviewWorkflowComponent", () => {
  let component: AuditReviewWorkflowComponent;
  let fixture: ComponentFixture<AuditReviewWorkflowComponent>;
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [AuditReviewWorkflowComponent],
      imports: [
        CommonModule,
        RouterTestingModule,
        FormsModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AuditReviewWorkflowComponent);
