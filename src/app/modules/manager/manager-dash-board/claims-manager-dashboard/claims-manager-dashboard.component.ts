...
@Component({
  selector: "app-claims-manager-dashboard",
  templateUrl: "./claims-manager-dashboard.component.html",
  styleUrls: ["./claims-manager-dashboard.component.css"]
})
export class ClaimsManagerDashboardComponent implements OnInit {
    ...
    this.auditorService
      ...
      .subscribe(
        res => {
          this.loaded = true;
          if (res && res.length > 0) {
            this.auditorCountData = this.processAuditorGraph(res);
            this.isDataPresent = true;
          } else {
            this.auditorCountData = [["NO DATA", 0, "0", 0, "0", 0, "0"]];
