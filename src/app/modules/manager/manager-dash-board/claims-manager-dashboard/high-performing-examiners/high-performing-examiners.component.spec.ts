...
import { HighPerformingExaminersComponent } from "./high-performing-examiners.component";
...
class MockAuditDashboardService extends AuditDashboardService {
  getHighPerExaminers() {
    ...
    this.highPerExaminersFetch.next(prodArray);
  }
}

describe("HighPerformingExaminersComponent", () => {
  let component: HighPerformingExaminersComponent;
  let fixture: ComponentFixture<HighPerformingExaminersComponent>;
  let localStorage: CryptoService;
  let chartService: ChartDetailService;
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [HighPerformingExaminersComponent],
      imports: [
        GoogleChartsModule,
        FormsModule,
        ReactiveFormsModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(HighPerformingExaminersComponent);
    component = fixture.componentInstance;
    localStorage = fixture.debugElement.injector.get(CryptoService);
    chartService = fixture.debugElement.injector.get(ChartDetailService);
  ...
  describe("get and set values", () => {
    ...
    it("should fetch high performing examiner data on OK button click when role is manager", () => {
      ...
      const locSpy = spyOn(component, "getHighPerExaminersManagerLead");
      fixture.detectChanges();
    ...
    it("should fetch no data to chart when response is not prsent", () => {
      ...
      fixture.detectChanges();
      component.getHighPerExaminersManagerLead();
      expect(locSpy).toHaveBeenCalled();
    });

    it("should fetch high performing examiner data on OK button click when role is lead", () => {
      component.submittedAudit = false;
    ...
    it("should fetch no data to chart when response is not present", () => {
      component.userAuditScoreDto = [];
      localStorage.setItem("roleId", "Claims Lead");
    ...
    it("should fetch high performing examiner data on OK button click when role is auditor", () => {
      component.submittedAudit = false;
      component.role = "Claims Auditor";
      localStorage.setItem("roleId", "Claims Auditor");
      const locSpy = spyOn(component, "getHighPerExaminersAuditor");
      fixture.detectChanges();
      component.onSubmitExaminer();
      expect(locSpy).toHaveBeenCalled();
      expect(component.submittedAudit).toBeTruthy();
    ...
    it("should fetch no data to chart when response is not prsent", () => {
      ...
      const locSpy = spyOn(component, "getExaminerChartNoValue");
      fixture.detectChanges();
      component.getHighPerExaminersAuditor();
      expect(locSpy).toHaveBeenCalled();
    });
  ...
  describe("should fetch data from service", () => {
    ...
    it("should call service to fetch high performing examiner data for auditor", () => {
      const today = new Date();
      const todaysDate = new Date(
        component.datePipe.transform(today, "yyyy-MM-dd")
      );
      ...
      defaultDateRange.push(todaysDate);
      component.examinerDates.get("dateRange").setValue(defaultDateRange);
      const servSpy = spyOn(serviceAuditor, "getHighPerExaminers");
      fixture.detectChanges();
      component.getHighPerExaminersAuditor();
    ...
    it("should data in chart as 'No Data' when error occurs for auditor", () => {
      ...
      defaultDateRange.push(todaysDate);
      component.examinerDates.get("dateRange").setValue(defaultDateRange);
      spyOn(serviceAuditor, "getHighPerExaminers").and.returnValue(
    ...
    it("should data in chart as 'No Data' when data is empty for auditor", () => {
      ...
      defaultDateRange.push(todaysDate);
      component.examinerDates.get("dateRange").setValue(defaultDateRange);
      spyOn(serviceAuditor, "getHighPerExaminers").and.returnValue(null);
      const locSpy = spyOn(component, "getExaminerChartNoValue");
      fixture.detectChanges();
      component.getHighPerExaminersAuditor();
      expect(locSpy).toHaveBeenCalled();
    ...
    it("should call service to fetch high performing examiner data for lead", () => {
      const today = new Date();
      const todaysDate = new Date(
        component.datePipe.transform(today, "yyyy-MM-dd")
      );
      ...
      defaultDateRange.push(todaysDate);
      component.examinerDates.get("dateRange").setValue(defaultDateRange);
      const servSpy = spyOn(serviceManager, "getHighPerExaminers");
      fixture.detectChanges();
      component.getHighPerExaminersManagerLead();
      expect(servSpy).toHaveBeenCalled();
    });
  ...
  it("should fetch bar data on chart click", () => {
    component.userAuditScoreDto = {
      auditScoreDto: [
        {
          examinerId: 1,
    ...
    spyOn(chartService, 'highPerformingDetails').and.returnValue(of([]));
    component.dataExaminer = [
      [
        "Tino", 0, "0"
      ]
    ];
    component.selectBar([{row: 0, column: 1}]);
    expect(component.chartDetails).toEqual([]);
    component.dataExaminer = [
      [
        "Tino", 0, "0"
      ]
    ];
    component.selectBar([{row: 0, column: 2}]);
    expect(component.chartDetails).toEqual([]);
  });

  it("should fetch bar data on chart click - no res", () => {
    component.userAuditScoreDto = {
      auditScoreDto: [
        {
          examinerId: 1,
    ...
    spyOn(chartService, 'highPerformingDetails').and.returnValue(of(null));
    component.dataExaminer = [
      [
        "Tino", 0, "0"
      ]
