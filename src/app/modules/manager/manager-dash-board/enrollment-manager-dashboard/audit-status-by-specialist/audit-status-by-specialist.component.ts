...
@Component({
  selector: "app-audit-status-by-specialist",
  templateUrl: "./audit-status-by-specialist.component.html",
  styleUrls: ["./audit-status-by-specialist.component.css"]
})
export class AuditStatusBySpecialistComponent
  ...
  openPopUp(e) {
    ...
    if (e.length > 0) {
      ...
      this.editUser = {
        ...
        specialistName,
        status: acct,
        singleSpecialistId: this.specialistIdArray[row],
  ...
  getAuditStatusSpecialist() {
    ...
    this.mapUsrGrpNameList(this.countByProdVolGroup.get("userGrpName").value);
    this.enrollmentManagerDashboardService.getAuditStatusSpecialist(
      this.datePipe.transform(fromDateValue, "yyyy-MM-dd"),
      this.datePipe.transform(toDateValue, "yyyy-MM-dd"),
      this.mapUserGrp(this.userGrpArray),
      this.mapSpecialist(this.countByProdVolGroup.get("specialistName").value)
    );
    this.managerReqCountScoreDto = this.enrollmentManagerDashboardService.auditStatusSpecialistResponse;
