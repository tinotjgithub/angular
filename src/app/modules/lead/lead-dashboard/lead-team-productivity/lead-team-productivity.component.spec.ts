...
import { LeadTeamProductivityComponent } from "./lead-team-productivity.component";
...
import { teamProductivitySchedule } from "src/app/mocks/dashboard-mock-data";
import { TaskmanagementService } from "src/app/services/task-management/taskmanagement.service";
import { of, throwError } from "rxjs";
import { MockBaseHttpService } from "src/app/mocks/base-http.mock";

class MockTaskMgtService extends TaskmanagementService {
  getLeadTeamProdScores() {
    const prodArray: any = teamProductivitySchedule;
    this.leadTeamProdScoreFetch.next(prodArray);
  }
}

describe("LeadTeamProductivityComponent", () => {
  let component: LeadTeamProductivityComponent;
  let fixture: ComponentFixture<LeadTeamProductivityComponent>;
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [LeadTeamProductivityComponent],
      imports: [
        GoogleChartsModule,
        FormsModule,
        ReactiveFormsModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(LeadTeamProductivityComponent);
  ...
  describe("get and set values", () => {
    ...
    it("should fetch teamProductivitySchedule data on OK button click", () => {
    ...
    it("should set tooltip text in chart to a default value when data is empty", () => {
      component.userProductivityDto = teamProductivitySchedule;
  ...
  describe("should fetch data from service", () => {
    ...
    it("should call service to fetch productivity by schedule data", () => {
      ...
      component.myTeamProductivityDates
        .get("dateRange")
        .setValue(defaultDateRange);
      const servSpy = spyOn(service, "getLeadTeamProdScores");
      fixture.detectChanges();
    ...
    it("should data in chart as 'No Data' when error occurs", () => {
      ...
      component.myTeamProductivityDates
        .get("dateRange")
        .setValue(defaultDateRange);
      spyOn(service, "getLeadTeamProdScores").and.returnValue(
  ...
  describe("should validate dates", () => {
    ...
    it("should calculate difference between two dates", () => {
      const today = new Date();
      component.isValid = false;
      spyOn(service, 'getLeadTeamProdScores').and.callFake(() => console.log('LeadTeamProdScores'));
      const todaysDate = new Date(
        component.datePipe.transform(today, "yyyy-MM-dd")
      );
      const defaultDateRange = [];
