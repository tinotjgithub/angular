...
export class AuditStatusComponent implements OnInit, OnDestroy {
  ...
  public myColumnNamesStatus = ["Passed", "Failed"];
  ...
  getStatusDays() {
    ...
    this.auditReportDashboardService.getAuditSamplingSts(
      this.datePipe.transform(fromDateValue, "yyyy-MM-dd"),
      this.datePipe.transform(toDateValue, "yyyy-MM-dd")
    );
    this.auditStatusCountDto = this.auditReportDashboardService.samplingStsResponse;
