...
@Component({
  selector: 'app-audit-passed',
  templateUrl: './audit-passed.component.html'
})
export class AuditPassedComponent implements OnInit {
  ...
  private getData() {
    this.gridData = [];
    this.service.getDeatilsList('audit-passed', this.type).subscribe((res) => {
      this.gridData = res;
    });
  }
